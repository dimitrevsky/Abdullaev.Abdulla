import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/devalue/index.js';
import destr from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/vue/index.mjs';
import { hash } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/dmitrymorozov/VScode-Projects/portfolio/node_modules/@unhead/shared/dist/index.mjs';
...
const _7zXGGA7aDF = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/dmitrymorozov/VScode-Projects/portfolio";
...
const _lazy_ONHad5 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ONHad5, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ONHad5, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"/Users/dmitrymorozov/VScode-Projects/portfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dmitrymorozov/VScode-Projects/portfolio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dmitrymorozov/VScode-Projects/portfolio/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dmitrymorozov/VScode-Projects/portfolio/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dmitrymorozov/VScode-Projects/portfolio/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dmitrymorozov/VScode-Projects/portfolio/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///Users/dmitrymorozov/VScode-Projects/portfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
